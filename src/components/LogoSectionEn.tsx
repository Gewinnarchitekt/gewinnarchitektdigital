...
interface LogoSectionEnProps {}
const LogoSectionEn = ({}: LogoSectionEnProps) => {
  const logos = [{
    name: "Goldbach",
    src: goldbachLogo,
    alt: "Goldbach Logo"
  ...
  return <section className="py-16 bg-muted">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">Successful with renowned brands</h2>
        </div>
