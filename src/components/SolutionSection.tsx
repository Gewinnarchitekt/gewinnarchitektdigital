...
const SolutionSection = ({}: SolutionSectionProps) => {
  const solutions = {
    ...
    "angebotsgestaltung": {
      ...
      color: "from-green-600 to-green-700",
      descriptions: ["Die klare Spezifikation des Problems und der Vergleich mit bestehenden \"Jobs To Be Done\" ermöglicht die Erstellung eines marktorientierten Angebots.", "Dieses strukturiere ich gemäss neuesten Erkenntnissen aus der Verhaltensforschung und bringe die Pricinglogik in Einklang mit dem Kundenkaufentscheidungsprozess.", "Begleitet wird der Prozess mit quantitativen Analysen bezüglich Marktpotential, Gewinnerwartung und Liquiditätsentwicklung."],
  ...
  return <section className="py-20 bg-muted">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          return <div key={key} className="bg-card rounded-xl p-6 card-shadow hover:elegant-shadow smooth-transition h-[600px] flex flex-col">
                ...
                <div className="space-y-4 mb-8 flex-grow">
                  {solution.descriptions.map((description, descIndex) => <p key={descIndex} className="text-muted-foreground leading-relaxed">
                      {description}
                    </p>)}
                </div>
