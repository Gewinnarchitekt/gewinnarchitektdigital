  ...
  const solutions = {
    ...
    angebotsoptimierung: {
      ...
      descriptions: [
        ...
        "Monat für Monat verbessern wir deine Profitabilität mithilfe konkreter, datenbasierte Massnahmen",
      ],
      note: undefined,
    ...
    angebotsgestaltung: {
      ...
      descriptions: [
        ...
        "Die Angebotsstruktur gestalten wir gemeinsam nach verhaltenspsychologischen Prinzipien und einheitlichen Kommunikationsstandards, die Transparenz schaffen und Kaufentscheidungen erleichtern.",
