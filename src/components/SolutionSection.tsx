...
const SolutionSection = ({}: SolutionSectionProps) => {
  const solutions = {
    ...
    angebotsgestaltung: {
      ...
      color: "from-green-600 to-green-700",
      descriptions: [
        "Die klare Spezifikation des Problems und das Studium bestehender Lösungsansätze ermöglicht die Erstellung eines marktorientierten Angebots.",
    ...
    <section className="py-20 bg-muted">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-bold mb-6">So helfe ich dir, maximale Wertschöpfung aus dem Markt zu holen</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {Object.entries(solutions).map(([key, solution]) => {
            ...
            return (
              <div
                key={key}
                className="bg-card rounded-xl p-6 card-shadow hover:elegant-shadow smooth-transition lg:h-[600px] flex flex-col"
              >
