...
const PricingSection = ({}: PricingSectionProps) => {
  const packages = [{
    ...
    features: ["Kundenanalysen", "Marktauswertungen", "Tracking- und Plansysteme", "Monatlicher Performancereport", "Abweichungsanalyse ggü. Plan", "Business Cases", "Szenariomodellierungen", "Mittel- und Langfristplanung"]
  }, {
    ...
    icon: Wrench,
    color: "from-green-600 to-green-700",
    features: ["Kundenanalysen", "Marktauswertungen", "Tracking- und Plansysteme", "Monatlicher Performancereport", "Abweichungsanalyse ggü. Vorjahr"]
  }, {
  ...
  return <section className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          return <div key={index} className="relative bg-card rounded-2xl p-8 card-shadow hover:elegant-shadow smooth-transition hover:-translate-y-1 flex flex-col">
